...
- `Gas_permeability_solubility_diffusivity_wide.csv` — the main training set.
  ...
  **Source:** developed by Rampi Ramprasad's group (Phan et al., 2024) — see
  citations below.
...
- `new_test_set.csv` — separate polymers used by the prediction script
  ...
  **Source:** experimental data from the Membrane Society of Australasia
...
**Training set** (`Gas_permeability_solubility_diffusivity_wide.csv`) — from
Rampi Ramprasad's group:
...
**Test set** (`new_test_set.csv`) — experimental data from the Membrane Society
of Australasia database; the p-SMILES were manually curated and added by us:
